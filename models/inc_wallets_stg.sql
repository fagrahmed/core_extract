...
SELECT
    ...
    (createdat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_createdat_utc2,
    (lastmodified::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_modifiedat_utc2,
    (suspendedat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_suspendedat_utc2,
    (unsuspendedat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_unsuspendedat_utc2,
    (unregisteredat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_unregisteredat_utc2,
    (activatedat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_activatedat_utc2,
    (reactivatedat::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_reactivatedat_utc2,
    (lasttxnts::timestamptz AT TIME ZONE 'UTC' + INTERVAL '3 hours') AS wallet_lasttxnts_utc2,
